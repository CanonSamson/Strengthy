...
const WorkingSchedule = () => {
  return (
    <section className="bg-customGray relative overflow-hidden text-[12px] md:text-sm text-customWhite">
      <div className="text-center max-w-[1100px] mx-auto py-[100px] mb-[100px]">
        ...
        <div className=" w-full overflow-x-auto relative  ">
          <div className=" min-w-[600px]  ">
            <ul className="mb-5 flex md:items-center text-[#878787] md:justify-center">
              {daysOfWeek.map((day) => (
                <li key={day}>
                  <button className=" px-2 md:px-5 py-2">{day}</button>
                </li>
              ))}
            </ul>
