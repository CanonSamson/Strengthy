...
export default function About() {
  return (
    <main className="">
      <header className=" overflow-hidden text-customWhite   bg-[#1C2128] h-[400px] mx-5 relative mb-10 flex items-center pt-[100px] flex-col ">
        <div className=" relative">
          <h1 className="absolute w-full top-1  opacity-30 animate-pulse z-0 text-5xl stroke max-w-[700px] text-center text-customGray3  pb-5 font-extrabold">
            Start with us the body and mind cleansing
          </h1>

          <h1 className=" w-full  relative z-1 text-5xl max-w-[700px] text-center stroke pb-5 font-extrabold">
            Start with us the body and mind cleansing
          </h1>
        </div>
        ...
        <Image
          ...
          width={500}
          height={500}
          className=" absolute -left-[20%] -bottom-20  w-auto opacity-20  h-[350px] "
        />
        <Image
          src="/images/homepage/hero-image-6.png"
          width={500}
          height={500}
          className=" absolute left-0 opacity-70  w-auto bottom-0 h-[350px] "
        />
      </header>
      <section className=" relative">
        <div className=" grid grid-cols-3 max-w-[800px] bg-white p-7 gap-7 mx-auto relative -mt-[203px]">
          <Image
          ...
          <Image
            ...
            width={500}
            height={500}
            className=" h-[350px] w-full object-cover col-span-2"
          />
        </div>
        <Image
      ...
      <section>
        <div className=" grid grid-cols-2 gap-10 text-sm   max-w-[1100px] mx-auto py-[100px]">
          <div>
            <span className="tracking-[4px] text-customGreen uppercase font-medium">
              Welcome
            </span>
            <h2 className=" text-4xl font-semibold w-[300px]">
          ...
          <div>
            <div className=" gap-10 grid col-span-1 h-full row-span-3 relative z-10">
      ...
      <section className=" bg-customGray4 text-customWhite">
        ...
        <div className=" gap-10 text-sm   max-w-[1100px] mx-auto py-[100px]">
          <div>
            <div className=" relative z-1 flex items-center justify-between ">
              <div>
                ...
                <h2 className=" text-2xl font-medium">My core work values</h2>
              </div>
              <Button
                text="Book a Class"
                style=" text-customGray bg-customGreen px-[30px]"
              />
            </div>
      ...
      <div className=" gap-10    max-w-[1100px] mx-auto  text-sm">
        <div className=" grid grid-cols-4 border-b border-l">
          <div className=" flex items-center py-10 flex-col border-r">
